...
var getRelativePath = (from, to) => {
  const relativePath = import_node_path.default.relative(import_node_path.default.dirname(from || ""), import_node_path.default.dirname(to || "")) || "./";
...
var DEFAULT_TYPE_NAME = "ClassNames";
